...
CREATE TABLE `auto` (
  ...
  `state_number` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `driver` (
  ...
  `female` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `birth_date` date DEFAULT NULL,
  `last_med_exam_date` date DEFAULT NULL,
  `drivers_license_number` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `routs`
  MODIFY `rout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
